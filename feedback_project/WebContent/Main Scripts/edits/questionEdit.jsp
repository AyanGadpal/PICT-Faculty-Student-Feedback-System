...
String option5=request.getParameter("op5");
...
st.executeUpdate("update question set question='"+question+"',option1='"+option1+"',option2='"+option2+"',option3='"+option3+"',option4='"+option4+"',option5='"+option5+"' where qid="+oqid+";");
