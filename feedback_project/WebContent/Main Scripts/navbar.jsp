<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <meta name="description" content="PICT Feedback System">
    <meta name="author" content="Devashish Prasad, Manish Visave, Aniket Velhankar, Ayan Gadpal, Kshtij Kapadni, Sameer Joshi">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="ins.jsp"><img class="brand-logo" alt="PICT logo" src="theme-assets/images/logo/pict.jpg"/>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="theli"><a href="../Start/Login.html"><i class="ft-bold"></i><span class="menu-title" data-i18n="">Logout</span></a>
          </li>
        </ul>
      </div>
		      ...
		      <div class="content-header-right col-md-8 col-12">
		        <div class="breadcrumbs-top float-md-right">
		          <div class="breadcrumb-wrapper mr-1">
		            <ol class="breadcrumb">
		              <li class="breadcrumb-item"><a href="ins.jsp">Home</a>
		              </li>
